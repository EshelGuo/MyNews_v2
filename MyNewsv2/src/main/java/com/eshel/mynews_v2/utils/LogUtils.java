...
import com.eshel.mynews_v2.config.Config;
 ...
 * @des	   日志级别是LEVEL_ALL显示�?有信�?,包括System.out.println信息
 * @des  日志级别是LEVEL_OFF关闭�?有信�?,包括System.out.println信息
 * @updateAuthor TODO
 * @updateTime TODO
 * @updateDes TODO
 */
public class LogUtils {
	...
	/** 是否允许输出log */
	private static int mDebuggable = Config.DEBUGLEVEL;
	...
	/** 以级别为 s 的形式输出LOG,主要是为了System.out.println,稍微格式化了�?�? */
